...
class Books(object):
    ...
    def get_topics_data(self):
        ...
        if self.topics:
            ...
            for topic in self.topics:
                subject_sql = subject_sql + "p.name LIKE '%" + topic + "%' OR "
                bookshelf_sql = bookshelf_sql + "p.name LIKE '%" + topic + \
                                "%' OR "
    ...
    def get_data(self):
        ...
        self.final_df.to_csv('D:/Test.csv')
